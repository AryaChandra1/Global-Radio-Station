...
// Major countries with their coordinates for globe markers
...
export function getCountryByCode(code: string): CountryCoordinates | undefined {
  return countryCoordinates.find(c => c.code === code);
}
